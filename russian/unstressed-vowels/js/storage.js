/* ==========================================================================
   storage.js — настройки и история сессий тренажёра «Безударные гласные»
   Глобальный объект UV.store (свои ключи, не пересекается с другими тренажёрами)
   ========================================================================== */

window.UV = window.UV || {};

UV.store = (function () {
  var SETTINGS_KEY = 'uv.settings.v1';
  var HISTORY_KEY = 'uv.history.v1';
