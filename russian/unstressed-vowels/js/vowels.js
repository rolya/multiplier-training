/* ==========================================================================
   vowels.js — ядро тренажёра «Безударные гласные в корне слова»:
   сборка сессии, задания, подсказки. Данные лежат в vowels-data.js (UV.data).
   ...
   Задание (task):
     { id, task, before, after, answer, options, word, hint,
       ...
       fromMistakes }
   before / after — куски слова вокруг пропуска: 'в[...]сенний' → 'в' и 'сенний'.
...
UV.core = (function () {
  ...
  /**
   * Ударный гласный в проверочном слове отмечен ЗАГЛАВНОЙ буквой («вЁсны»).
   * Ребёнку слово показываем строчным, а позицию запоминаем — её подсветим.
   * Если заглавных нет (парные согласные), возвращаем -1.
   */
