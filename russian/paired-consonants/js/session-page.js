/* ==========================================================================
   session-page.js — тренировка и итоги «Парные согласные» (session.html)
...
(function () {
  ...
  var LEAD_HELP = 'Вот проверочные слова — в них согласный слышно чётко:';
  ...
  /** Проверочное слово (в этом датасете отметок ударения нет) */
